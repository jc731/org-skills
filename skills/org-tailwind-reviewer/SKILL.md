...
- **Accessibility** (semantics, keyboard, focus, contrast) surfaces in the UI you’re reviewing → Apply **org-accessibility** or note in feedback that org-accessibility should run.
